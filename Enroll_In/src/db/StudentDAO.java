...
public class StudentDAO extends BaseHibernateDAO {
	...
	public Student findById(java.lang.String id) {
		...
		try {
			Student instance = (Student) getSession().get("db.Student", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Student instance) {
		...
		try {
			List results = getSession().createCriteria("db.Student").add(
	...
	public List findBySpw(Object spw) {
		return findByProperty(SPW, spw);
	}
