...
public class TeacherDAO extends BaseHibernateDAO {
	...
	public static final String TPSW = "tpsw";
	...
	public Teacher findById(java.lang.String id) {
		...
		try {
			Teacher instance = (Teacher) getSession().get("db.Teacher", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = getSession().createCriteria("db.Teacher").add(
	...
	public List findByTpsw(Object tpsw) {
		return findByProperty(TPSW, tpsw);
	}
