...
<div class="zhong">
  ...
  <div class="main">
    ...
    <div class="right">
      ...
      <s:form width="100%">
      	<tr><p><strong>选修课程【<%=coursename %>】的学生如下：</strong></p></tr>
      	<br/>
      	<tr>
      		<th width="30%">学生学号</th>
      		<th width="30%">学生姓名</th>
      	</tr>
      <s:iterator value="#session.student_Courses" var="student">
      <tr>
      <div align="left">
      	<td width="30%" align="center"><s:property value="#student.sid"/></td>
      	<td width="30%" align="center"><s:property value="#student.sname"/></td>
      </div>
      </tr>
      </s:iterator>
      </s:form>
