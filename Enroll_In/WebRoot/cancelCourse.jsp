...
<div class="zhong">
  ...
  <div class="main">
    ...
    <div class="right">
      ...
      <s:form width="100%" boarder="1">
      <tr><p><strong>可退选课程：</strong></p></tr>
      <tr>
      	<th width="30%">课程名称</th>
      	<th width="30%">退选情况</th>
      </tr>
      ...
      <div align="left">
      	...
      	<td width="30%" align="center"><a href="cancelCourse?student=<%=username%>&course=<s:property value="#course.cid"/>">【退选】</a></td>
      </div>
      </tr>
      </s:iterator>
      </s:form>
