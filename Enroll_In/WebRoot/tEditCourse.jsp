...
<div class="zhong">
  ...
  <div class="main">
    ...
    <div class="right">
      ...
      <s:form width="100%">
      <tr><p><strong>您所教课程：</strong></p></tr>
      <br/>
      <tr>
      	<th width="25%">课程ID</th>
      	<th width="25%">课程名称</th>
      	<th width="25%">课程描述</th>
      	<th width="25%">修改描述信息</th>
      </tr>
      <s:iterator value="#session.teachCourse" var="course">
      <tr>
      <div align="left">	
      	<td width="25%" align="center"><s:property value="#course.cid"/></td>
      	<td width="25%" align="center"><s:property value="#course.cname"/></td>
      	<td width="25%" align="center"><s:property value="#course.cdescription"/></td>
      	<td width="25%" align="center"><a href="editTrans?cid=<s:property value="#course.cid"/>">【修改描述信息】</a></td>
      </div>
      </tr>
      </s:iterator>
      </s:form>
